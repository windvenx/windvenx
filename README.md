...
<p align="center">
  <img src="https://skillicons.dev/icons?i=js,ts,react,nextjs,redux,html,css,scss,tailwind,git,linux,bash,aws,debian,redhat,nix,nestjs,docker,kubernetes,ansible,terraform,gitlab,prometheus,grafana,postgres" />
</p>
